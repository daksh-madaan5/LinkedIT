    ...
    <div className="w-full h-full overflow-auto bg-white">
      <table className="w-full text-left border-collapse text-xs">
        <thead className="bg-slate-50 sticky top-0 z-10 border-b border-slate-200 text-slate-700 select-none">
          <tr>
            <th className="py-2 px-3 font-semibold text-left w-28">Vehicle</th>
            <th className="py-2 px-3 font-semibold text-center w-24">Total Stops</th>
            <th className="py-2 px-3 font-semibold text-right w-28">Distance</th>
            <th className="py-2 px-3 font-semibold text-right w-28">Duration</th>
            <th className="py-2 px-3 font-semibold text-left w-40">Capacity Utilization</th>
            <th className="py-2 px-3 font-semibold text-left">Stop Sequence</th>
          </tr>
        </thead>
